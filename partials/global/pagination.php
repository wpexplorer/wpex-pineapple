...
if ( $total > 1 ) :
	...
	<?php else :
		...
		$next = get_previous_posts_link( esc_html__( 'Newer Entries', 'wpex-pineapple' ) .'<span class="fa fa-chevron-right" aria-hidden="true"></span>' );
		$prev = get_next_posts_link( '<span class="fa fa-chevron-left" aria-hidden="true"></span>'. esc_html__( 'Older Entries', 'wpex-pineapple' ) ); ?>
